 ...
 * Time:9:57
 **/
public class Gson2MessageConverter extends AbstractJsonMessageConverter
{
    private Logger log=Logger.getLogger(Gson2MessageConverter.class);
    private static ClassMapper classMapper =  new DefaultClassMapper();

    private static Gson gson = new Gson();

    public Gson2MessageConverter() {
        super();
    }
